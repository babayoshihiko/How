...
### Abstract {#sec-design-abstract}

Abstracrt は、「抄録」や「要旨」です。「抄録」よりも Abstract という表現の方が良く使われているので、Abstract とします。なお、自動翻訳すると Anstract が「抽象的な」と訳されることが多いです。

Abstract は、論文の要旨や抄録などと訳されます。本文が有料で読むことができなくても、Abstract までは読むことができます。臨床系の論文では、方法論、結果、結論が簡潔にまとまっていることが多く、Abstract だけで概要がわかるようになっています。

近年の臨床系の Abstract は、多くの場合 Structured abstract です。これは、**Objective**、**Results**、**Conmclusion** などのように、見出しがついている Abstract です。

どのような見出しを使うかは、ジャーナルが指定することが多いです。BMJ Open も同様です ([https://bmjopen.bmj.com/pages/authors#submission_guidelines](https://bmjopen.bmj.com/pages/authors#submission_guidelines))。
...
OA ジャーナルとは、インターネット上で誰でも無料で閲覧できる学術誌です。紙媒体では流通していません。有名どころでは、PLOS 系、Scientific Reports などがあります。
...
ジャーナルで気をつけないといけない点として、「ハゲタカジャーナル」(Predetaroy journals) の存在があります。これは、掲載料収入を目的としたジャーナルで、論文の正当性や質が十分に保証されていないジャーナルのことです。杏林大学図書館も 2018 年に、[ハゲタカジャーナルにご注意ください](https://library.kyorin-u.ac.jp/index.php?key=joosi9tmm-73031)という注意喚起ががなされました。
